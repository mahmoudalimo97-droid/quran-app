...
export const SURAH_LIST: SurahMeta[] = [
  ...
  { number: 2, name: "البقرة", englishName: "Al-Baqarah", englishNameTranslation: "The Cow", revelationType: "Medinan", numberOfAyahs: 286, juz: 1 },
  { number: 3, name: "آل عمران", englishName: "Aal-e-Imran", englishNameTranslation: "Family of Imran", revelationType: "Medinan", numberOfAyahs: 200, juz: 3 },
  { number: 4, name: "النساء", englishName: "An-Nisa'", englishNameTranslation: "The Women", revelationType: "Medinan", numberOfAyahs: 176, juz: 4 },
  { number: 5, name: "المائدة", englishName: "Al-Ma'idah", englishNameTranslation: "The Table Spread", revelationType: "Medinan", numberOfAyahs: 120, juz: 6 },
  { number: 6, name: "الأنعام", englishName: "Al-An'am", englishNameTranslation: "The Cattle", revelationType: "Meccan", numberOfAyahs: 165, juz: 7 },
  { number: 7, name: "الأعراف", englishName: "Al-A'raf", englishNameTranslation: "The Heights", revelationType: "Meccan", numberOfAyahs: 206, juz: 8 },
  { number: 8, name: "الأنفال", englishName: "Al-Anfal", englishNameTranslation: "The Spoils of War", revelationType: "Medinan", numberOfAyahs: 75, juz: 9 },
  { number: 9, name: "التوبة", englishName: "At-Tawbah", englishNameTranslation: "The Repentance", revelationType: "Medinan", numberOfAyahs: 129, juz: 10 },
  { number: 10, name: "يونس", englishName: "Yunus", englishNameTranslation: "Jonah", revelationType: "Meccan", numberOfAyahs: 109, juz: 11 },
  { number: 11, name: "هود", englishName: "Hud", englishNameTranslation: "Hud", revelationType: "Meccan", numberOfAyahs: 123, juz: 11 },
  { number: 12, name: "يوسف", englishName: "Yusuf", englishNameTranslation: "Joseph", revelationType: "Meccan", numberOfAyahs: 111, juz: 12 },
  ...
  { number: 18, name: "الكهف", englishName: "Al-Kahf", englishNameTranslation: "The Cave", revelationType: "Meccan", numberOfAyahs: 110, juz: 15 },
  ...
  { number: 25, name: "الفرقان", englishName: "Al-Furqan", englishNameTranslation: "The Criterion", revelationType: "Meccan", numberOfAyahs: 77, juz: 18 },
  ...
  { number: 27, name: "النمل", englishName: "An-Naml", englishNameTranslation: "The Ants", revelationType: "Meccan", numberOfAyahs: 93, juz: 19 },
  ...
  { number: 29, name: "العنكبوت", englishName: "Al-Ankabut", englishNameTranslation: "The Spider", revelationType: "Meccan", numberOfAyahs: 69, juz: 20 },
  ...
  { number: 33, name: "الأحزاب", englishName: "Al-Ahzab", englishNameTranslation: "The Combined Forces", revelationType: "Medinan", numberOfAyahs: 73, juz: 21 },
  ...
  { number: 36, name: "يس", englishName: "Ya-Sin", englishNameTranslation: "Ya-Sin", revelationType: "Meccan", numberOfAyahs: 83, juz: 22 },
  ...
  { number: 38, name: "ص", englishName: "Sad", englishNameTranslation: "The Letter Sad", revelationType: "Meccan", numberOfAyahs: 88, juz: 23 },
  { number: 39, name: "الزمر", englishName: "Az-Zumar", englishNameTranslation: "The Groups", revelationType: "Meccan", numberOfAyahs: 75, juz: 23 },
  { number: 40, name: "غافر", englishName: "Ghafir", englishNameTranslation: "The Forgiver", revelationType: "Meccan", numberOfAyahs: 85, juz: 24 },
  { number: 41, name: "فصلت", englishName: "Fussilat", englishNameTranslation: "Explained in Detail", revelationType: "Meccan", numberOfAyahs: 54, juz: 24 },
  ...
  { number: 45, name: "الجاثية", englishName: "Al-Jathiyah", englishNameTranslation: "The Kneeling", revelationType: "Meccan", numberOfAyahs: 37, juz: 25 },
  { number: 46, name: "الأحقاف", englishName: "Al-Ahqaf", englishNameTranslation: "The Curved Sand-dunes", revelationType: "Meccan", numberOfAyahs: 35, juz: 26 },
  ...
  { number: 49, name: "الحجرات", englishName: "Al-Hujurat", englishNameTranslation: "The Dwellings", revelationType: "Medinan", numberOfAyahs: 18, juz: 26 },
  { number: 50, name: "ق", englishName: "Qaf", englishNameTranslation: "The Letter Qaf", revelationType: "Meccan", numberOfAyahs: 45, juz: 26 },
  { number: 51, name: "الذاريات", englishName: "Adh-Dhariyat", englishNameTranslation: "The Winnowing Winds", revelationType: "Meccan", numberOfAyahs: 60, juz: 26 },
  ...
  { number: 56, name: "الواقعة", englishName: "Al-Waqi'ah", englishNameTranslation: "The Inevitable", revelationType: "Meccan", numberOfAyahs: 96, juz: 27 },
  ...
  { number: 60, name: "الممتحنة", englishName: "Al-Mumtahanah", englishNameTranslation: "The Examined One", revelationType: "Medinan", numberOfAyahs: 13, juz: 28 },
  { number: 61, name: "الصف", englishName: "As-Saff", englishNameTranslation: "The Ranks", revelationType: "Medinan", numberOfAyahs: 14, juz: 28 },
  { number: 62, name: "الجمعة", englishName: "Al-Jumu'ah", englishNameTranslation: "The Congregation", revelationType: "Medinan", numberOfAyahs: 11, juz: 28 },
  ...
  { number: 76, name: "الإنسان", englishName: "Al-Insan", englishNameTranslation: "Man", revelationType: "Medinan", numberOfAyahs: 31, juz: 29 },
  ...
  { number: 86, name: "الطارق", englishName: "At-Tariq", englishNameTranslation: "The Morning Star", revelationType: "Meccan", numberOfAyahs: 17, juz: 30 },
  ...
  { number: 93, name: "الضحى", englishName: "Ad-Duha", englishNameTranslation: "The Morning Hours", revelationType: "Meccan", numberOfAyahs: 11, juz: 30 },
  ...
  { number: 101, name: "القارعة", englishName: "Al-Qari'ah", englishNameTranslation: "The Calamity", revelationType: "Meccan", numberOfAyahs: 11, juz: 30 },
